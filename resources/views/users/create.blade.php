	...
	<div class="card mar-top-20">
		<div class="card-body">
			<div class="mar-bot-1" >
				...
				<form class="mar-top-20" method="POST" action="/user/store" >
					{{ csrf_field() }}
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="firstname">ชื่อ <span class="dokchan" >*</span></label>
							<input type="text" class="form-control {{ $errors->has('firstname') ? 'is-invalid' : '' }} " name="firstname" id="firstname" value="{{ old('firstname') }}" placeholder="ชื่อ" required autofocus >
						...
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control {{ $errors->has('lastname') ? 'is-invalid' : '' }} " name="lastname" id="lastname" value="{{ old('lastname') }}" placeholder="นามสกุล" required autofocus >
						...
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control {{ $errors->has('tel') ? 'is-invalid' : '' }} " name="tel" id="tel" value="{{ old('tel') }}" placeholder="เบอร์โทรศัพท์" required autofocus >
						...
						<div class="form-group col-md-6">
							...
							<input type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }} " name="email" id="email" value="{{ old('email') }}" placeholder="อีเมลล์" required autofocus >
					...
					<div class="form-group">
						...
						<input type="text" class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }} " name="address" id="address" value="{{ old('address') }}" placeholder="ที่อยู่" required autofocus >
					...
					<div class="form-row">
						...
						<div class="form-group col-md-3">
							...
							<input type="text" class="form-control {{ $errors->has('zipcode') ? 'is-invalid' : '' }}" name="zipcode" id="zipcode" value="{{ old('zipcode') }}" placeholder="รหัสไปรษณีย์" required autofocus >
